    ...
    <div className="flex min-h-screen items-center justify-center bg-sand-100 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="font-display text-2xl font-semibold text-forest-800">DietTrackbyMo</h1>
          <p className="mt-1 text-sm text-forest-500">Masuk untuk melanjutkan progres dietmu</p>
        </div>
        ...
        <p className="mt-5 text-center text-sm text-forest-600">
          Belum punya akun?{' '}
          <Link to="/daftar" className="font-semibold text-forest-800 hover:underline">
            Daftar sekarang
          </Link>
        </p>
      </div>
